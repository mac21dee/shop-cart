    ...
    this.state = {
      products: [
        ...
        },
        {
          ...
          title: 'Laptop',
          qty: 5,
          img: 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=334&q=80',
          id: 3
        }
      ]
    }
  ...
  render () {
    ...
    return (
      <div className="App">
        ...
        />
        <div style={ { fontSize: 20,textAlign: 'center',width: 200} }>TOTAL: {this.getCartTotal()} </div>
      </div>
    );
  }
}
